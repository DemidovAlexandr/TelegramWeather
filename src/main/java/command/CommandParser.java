...
public class CommandParser {
    ...
    private final String botName = BotConfig.BOT_NAME;

    public ParsedCommand getParsedCommand(Message message) {
        Location location = message.getLocation();
        if (location != null) {
            return new ParsedCommand(Command.LOCATION, location.getLatitude(), location.getLongitude());
        }
